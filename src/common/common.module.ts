...
import { APP_LANGUAGE } from '../app/constant/app.constant';
import { TypeOrmModule } from '@nestjs/typeorm';
import { DatabaseOptionsModule } from './database/database.option.module';
import { DatabaseOptionsService } from './database/service/database.options-service.service';
  ...
  imports: [
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        DATABASE_NAME: Joi.string().default('parking-spot-db').required(),
        DATABASE_USER: Joi.string().allow(null, 'postgres').optional(),
        DATABASE_PASSWORD: Joi.string().allow(null, 'postgres').optional(),
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: async (configService: DatabaseOptionsService) =>
        configService.createOptions(),
